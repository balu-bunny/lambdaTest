    ...
    * The inserted record will be removed when test completed.
    ...
    def setUpClass(cls) -> None:
        ...
        state_machine_resources = [
            resource for resource in resources if resource["LogicalResourceId"] == "SFBackupStateMachine"
        ]
        ...
        if not state_machine_resources or not transaction_table_resources:
            raise Exception("Cannot find SFBackupStateMachine or TransactionTable")
