...
* lambda-pythonSetpFunction:SFBackupStateMachine
* lambda-pythonSetpFunction:StockCheckerFunction (python3.13)
* lambda-pythonSetpFunction:StockSellerFunction (python3.13)
* lambda-pythonSetpFunction:StockBuyerFunction (python3.13)
* lambda-pythonSetpFunction:TransactionTable
